...
> {
  ...
  oauth2Code = () => {
    ...
    window.open(`http://127.0.0.1:7001/oauth2.0/show?response_type=code&client_id=${client_id}&redirect_uri=${redirect_uri}&state=${state}`)
  }
      ...
      <div className={styles.main}>
        ...
        >
          ...
          <div className={styles.other}>
            ...
            <Icon type="login" onClick={this.oauth2Code} className={styles.icon} />
